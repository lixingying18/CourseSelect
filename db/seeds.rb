...
teacher_map={
    1 => {name: "魏峻", department: "xx饭店"},
    2 => {name: "张晋连", department: "xx饭店"}
}
...
course_map={
    ...
    2 => {course_code: "09MGX005H", name: "Python语言导论", course_type: "公共选修课", credit: "40/1.0", limit_num: 154, course_week: "第4-14周	", course_time: "周二(7-8)", class_room: "教1-108", teaching_type: "课堂讲授为主", exam_type: "课堂开卷"},
}
